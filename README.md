...
Maven — Build and dependency management
 ...
 Key Files
FirstProjectJavaSpringApplication.java
The main entry point of the application. Uses the @SpringBootApplication annotation to enable auto-configuration and component scanning, then launches the embedded web server via SpringApplication.run().
HelloController.java
